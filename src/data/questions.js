export const questions = [
  ...
  { id: 32, equation: 'x × 6 = 42',  answer: 7,  hint: 'Divide both sides by 6', explanation: 'x = 42 ÷ 6 = 7' },
  { id: 33, equation: 'x × 2 = 18',  answer: 9,  hint: 'Divide both sides by 2', explanation: 'x = 18 ÷ 2 = 9' },
  { id: 34, equation: 'x × 11 = 44', answer: 4,  hint: 'Divide both sides by 11',explanation: 'x = 44 ÷ 11 = 4' },
  { id: 35, equation: 'x × 7 = 56',  answer: 8,  hint: 'Divide both sides by 7', explanation: 'x = 56 ÷ 7 = 8' },

  // ── Division ──
  { id: 36, equation: 'x ÷ 2 = 5',   answer: 10, hint: 'Multiply both sides by 2', explanation: 'x = 5 × 2 = 10' },
  { id: 37, equation: 'x ÷ 3 = 4',   answer: 12, hint: 'Multiply both sides by 3', explanation: 'x = 4 × 3 = 12' },
  { id: 38, equation: 'x ÷ 4 = 3',   answer: 12, hint: 'Multiply both sides by 4', explanation: 'x = 3 × 4 = 12' },
  { id: 39, equation: 'x ÷ 5 = 3',   answer: 15, hint: 'Multiply both sides by 5', explanation: 'x = 3 × 5 = 15' },
  { id: 40, equation: 'x ÷ 2 = 7',   answer: 14, hint: 'Multiply both sides by 2', explanation: 'x = 7 × 2 = 14' },
  { id: 41, equation: 'x ÷ 3 = 6',   answer: 18, hint: 'Multiply both sides by 3', explanation: 'x = 6 × 3 = 18' },
  { id: 42, equation: 'x ÷ 4 = 5',   answer: 20, hint: 'Multiply both sides by 4', explanation: 'x = 5 × 4 = 20' },
  { id: 43, equation: 'x ÷ 6 = 3',   answer: 18, hint: 'Multiply both sides by 6', explanation: 'x = 3 × 6 = 18' },
  { id: 44, equation: 'x ÷ 5 = 4',   answer: 20, hint: 'Multiply both sides by 5', explanation: 'x = 4 × 5 = 20' },
  { id: 45, equation: 'x ÷ 7 = 3',   answer: 21, hint: 'Multiply both sides by 7', explanation: 'x = 3 × 7 = 21' },
  { id: 46, equation: 'x ÷ 8 = 4',   answer: 32, hint: 'Multiply both sides by 8', explanation: 'x = 4 × 8 = 32' },
  { id: 47, equation: 'x ÷ 9 = 5',   answer: 45, hint: 'Multiply both sides by 9', explanation: 'x = 5 × 9 = 45' },
  { id: 48, equation: 'x ÷ 6 = 7',   answer: 42, hint: 'Multiply both sides by 6', explanation: 'x = 7 × 6 = 42' },
  { id: 49, equation: 'x ÷ 11 = 3',  answer: 33, hint: 'Multiply both sides by 11',explanation: 'x = 3 × 11 = 33' },
  { id: 50, equation: 'x ÷ 4 = 8',   answer: 32, hint: 'Multiply both sides by 4', explanation: 'x = 8 × 4 = 32' },
]
